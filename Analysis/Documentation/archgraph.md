...
`archgraph.ps1` parses the per-file architecture Markdown documents produced by `archgen.ps1`
...
.\Analysis\archgraph.ps1
```

**Via AnalysisPipeline.py:**
Called as the third analysis step (after `archgen.ps1` and `archxref.ps1`):
```
