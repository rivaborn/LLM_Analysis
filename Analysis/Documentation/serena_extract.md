...
optionally trimmed source) enriches the per-file docs generated by `archgen.ps1`. Each source
file gets a `.serena_context.txt` file placed in `Analysis/.serena_context/`, which Pass 1
...
.\..\..\LLM_Analysis\Analysis\serena_extract.ps1 -Preset unreal
```
...
.\Analysis\serena_extract.ps1 -Preset unreal -Jobs 4
```
